...
function RedirectionScript()
		...
		function commence(){
			...
			document.getElementById('image').src='<?php echo $drap[0];?>';
			document.getElementById('commancer').style.display='none';
			document.getElementById('v1').style.display='block';
			document.getElementById('question').style.display='block';
			document.getElementById('mapid').style.display='block';
			f11(<?php echo $coordonnee[0];?>,3);
		}
</script>
...
<br>
 <h3 id="5" hidden>Bienvenue  vous avez <span style="color: red;">5 minutes</span> pour répondre aux questions !</h3><button id="commancer" type="button" class="btn btn-primary" style="width:200px; heigth:300px; margin-left:400px" onclick="commence();">Commencer</button>
 <br>
	...
	<div class="row">
  		...
  		<div class="row">
			  ...
			  sont un pays transcontinental dont l'essentiel du territoire se situe en Amérique du Nord. </p></p>
				...
				<form action="correctionQuiz1MI.php" method="post">
			...
			<div class="chronometre" id="timer" hidden>
			  <div class="tim">
				...
				<kbd >0 ms</kbd>
			 	...
			 	<button id="question" style="border-right: 5px; padding-right: 30px;width: 700px; height: 30px" hidden> Trouvez la capitale du pays qui s'affiche en cliquant sur la carte </button> 
