...
if (isset($_POST["valider"])){
		...
		if(($lat7<=(-77.2-5) and $lat7 >(-77.2+5)) and ($lng7< (38.53 +5 )and $lng7 > (38.53 -5)))
			...
			/*	$id = $_SESSION;
				$id_c = 1;
				echo $_SESSION;
				$sql= "INSERT INTO `score_c`(id,id_c,score_c) VALUES('$id',$id_c,'$score')";
				try{
					$com = $pdo->prepare($sql);
					$bool= $com->execute(array($id,$id_c,$score));
					if($bool){
						echo "insertion score ok";
					} else{
						echo "le score n'a pas pu être inserer";
					}
				}catch (PDOException $e) {
					echo utf8_encode("Echec de insert score : " . $e->getMessage() . "\n");
					die();
				}*/
}
?>
...
<br>
<br>
<a href="questionnaireContinent.php"><button id="replay" class="btn btn-dark w3-animate-left" style="background-color: green;color: white; text-align: center; width:300px; height:50px; margin-left:400px">rejouer</button></a>
<br>
<br>
<a href="/quiz1/questionnaireContinent.php"><button class="btn btn-dark w3-animate-right" style="background-color: green;color: white; text-align: center; width:300px; height:50px; margin-left:400px">Autre Quiz Continent</button></a>
<br>
<br>
<a href="/quiz2/questionnairePays.php"><button class="btn btn-dark w3-animate-bottom" style="background-color: green;color: white; text-align: center; width:300px; height:50px; margin-left:400px"> Quiz Pays</button></a>
<br><br>
 <a href="/project1/Joueur.php"><button class="btn btn-dark w3-animate-right" style="background-color: green;color: white; text-align: center; width:300px; height:50px; margin-left:400px">Retourner au Profil</button></a>
</body>
<html>
